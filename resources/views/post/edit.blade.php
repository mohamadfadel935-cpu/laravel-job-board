    ...
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <input id="title" type="text" name="title"value="{{old('title',$post->title)}}" autocomplete="given-name" 
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <input id="author" type="text" name="author"value="{{ old('author',$post->author)}}" autocomplete="family-name" 
        ...
        <div class="col-span-full">
          ...
          <div class="mt-2">
            ...
            class="{{ $errors->has('body') ? 'outline-red-500' : 'outline-gray-300'}} block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1
             placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">{{ old('body',$post->body) }}</textarea>
          </div>
       ...
       <div class="col-span-full"> 
        <div class="flex gap-3">
              ...
              <div class="text-sm/6">
                <label for="publish" class="font-medium text-gray-900">Is Published ?</label>
                <p id="publish-description" class="text-gray-500">Do you want it published or saved this draft.</p>
              </div>
            </div>
            </div>
      </div>
